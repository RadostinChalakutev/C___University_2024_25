...
/*Тъй като обект от производния клас е обект и от базовия клас, то можем да използваме операция присвояване с
ляв аргумент обект от (базовия клас) Clock и  десен аргумент - обект от (производния клас)
TravelClock (обратното не е вярно).
- Ефектът обаче е отрязване на данните (при операция присвояване),
дефинирани в производния клас, т.е. на данните location и time_difference.
*/
int main()
{
