...
public:
   ...
   int getMinute() const;
   int getSecond() const;
   int seconds_from(const Time& other) const;
...
int Time::seconds_from(const Time& other) const {
   int this_seconds = hour * 3600 + minute * 60 + second;
   int other_seconds = other.hour * 3600 + other.minute * 60 + other.second;
